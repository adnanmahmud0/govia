...
class AttorneyProfileView extends GetView<AttorneyProfileController> {
  const AttorneyProfileView({super.key});
          ...
          child: Column(
            ...
            children: [
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    'Licensed: ${controller.licensedStates.value}',
                                    maxLines: 1,
                                    overflow: TextOverflow.ellipsis,
                                    style: GoogleFonts.inter(
                                      fontSize: 11.5.sp,
              ...
              _buildOptionItem(
                ...
                title: 'Setting',
                onTap: () => Get.toNamed(AppRoutes.attorneySettings),
              ),
              _buildOptionItem(
              ...
              _buildOptionItem(
                ...
                onTap: () => Get.toNamed(AppRoutes.attorneySubpoenaRequest),
              ),
              _buildOptionItem(
                ...
                onTap: () {
                  Get.snackbar(
                    'Bail Bondsman',
                    'Redirecting to Bail Bondsman directory...',
                    snackPosition: SnackPosition.BOTTOM,
