                        ...
                        child: Column(
                          children: [
                            ...
                            SliderTheme(
                              ...
                              child: Slider(
                                min: 0.0,
                                max: currentVideo['durationSeconds'] as double,
                                value: controller.currentPosition.value.clamp(
                                  0.0,
                                  currentVideo['durationSeconds'] as double,
                                ),
                                onChanged: (value) {
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      Get.snackbar(
                                        'Fullscreen',
                                        'Fullscreen player is not available in mock mode.',
