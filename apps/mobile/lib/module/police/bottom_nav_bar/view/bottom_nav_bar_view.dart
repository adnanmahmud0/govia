...
class PoliceBottomNavBarView extends GetView<PoliceBottomNavBarController> {
  const PoliceBottomNavBarView({super.key});

  @override
  Widget build(BuildContext context) {
    final List<Widget> screens = [
      const PoliceHomeView(),
      const PoliceScheduleView(),
      const PoliceNotificationView(),
