...
class CitizenRegisterView extends GetView<CitizenRegisterController> {
              ...
              children: [
                ...
                Center(
                  child: Padding(
                    ...
                    child: Text(
                      'Create your secure citizen account to access government services and benefits',
                ...
                // Preferred Attorney / Firm
                CustomTextField(
                  label: 'Preferred Attorney / Law Firm (Optional)',
                  hintText: 'Enter Preferred Attorney or Firm',
                  controller: controller.preferredAttorneyController,
                ),
                SizedBox(height: 20.h),

                // Preferred Bail Bondsman
                CustomTextField(
                  label: 'Preferred Bail Bondsman (Optional)',
                  hintText: 'Enter Preferred Bail Bondsman',
                  controller: controller.preferredBailBondsmanController,
                ),
                SizedBox(height: 20.h),
