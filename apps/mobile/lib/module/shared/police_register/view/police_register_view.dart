...
class PoliceRegisterView extends GetView<PoliceRegisterController> {
  const PoliceRegisterView({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextField(
                  ...
                  hintText: 'E.G 1245-6548',
                  controller: controller.assignedNumberController,
                ),
                SizedBox(height: 20.h),

                // Department/Precinct
                CustomTextField(
                  label: 'Department/Precinct',
                  hintText: 'Enter Your Department/Precinct',
                ...
                // Did Your Car # Change?
                CustomTextField(
                  label: 'Did Your Car # Change?',
                  hintText: 'Type Here ...Yes Or Na',
                  controller: controller.carChangeController,
                ),
                SizedBox(height: 20.h),

                // Enter New Car Number
                CustomTextField(
                  label: 'Enter New Car Number',
                  hintText: '2654',
                  controller: controller.newCarNumberController,
                ),
