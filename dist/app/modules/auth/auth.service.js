...
const loginUserFromDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isExistUser.verified) {
        (0, debug_1.debug)('auth.login.db.not_verified', { email });
    ...
    if (isExistUser.status === 'delete') {
        (0, debug_1.debug)('auth.login.db.deactivated', { email });
    ...
    if (password &&
        ...
        (0, debug_1.debug)('auth.login.db.password_mismatch', { email });
    ...
    (0, debug_1.debug)('auth.login.db.tokens_created', { email });
...
const forgetPasswordToDB = (email, role) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, debug_1.debug)('auth.forget_password.email_sent', { email });
    //save to DB
    ...
    (0, debug_1.debug)('auth.forget_password.saved', { email });
});
//verify email
const verifyEmailToDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!oneTimeCode) {
        (0, debug_1.debug)('auth.verify_email.otp_missing', { email });
    ...
    if (((_a = isExistUser.authentication) === null || _a === void 0 ? void 0 : _a.oneTimeCode) !== oneTimeCode) {
        (0, debug_1.debug)('auth.verify_email.otp_mismatch', { email });
    ...
    if (date > ((_b = isExistUser.authentication) === null || _b === void 0 ? void 0 : _b.expireAt)) {
        (0, debug_1.debug)('auth.verify_email.otp_expired', { email });
    ...
    if (!isExistUser.verified) {
        ...
        (0, debug_1.debug)('auth.verify_email.verified', { email });
        ...
        (0, debug_1.debug)('auth.verify_email.reset_token_created', { email });
        message =
...
const resetPasswordToDB = (token, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isExistToken) {
        (0, debug_1.debug)('auth.reset_password.token_missing');
    ...
    if (!((_a = isExistUser === null || isExistUser === void 0 ? void 0 : isExistUser.authentication) === null || _a === void 0 ? void 0 : _a.isResetPassword)) {
        (0, debug_1.debug)('auth.reset_password.permission_denied');
    ...
    if (!isValid) {
        (0, debug_1.debug)('auth.reset_password.token_expired');
    ...
    if (newPassword !== confirmPassword) {
        (0, debug_1.debug)('auth.reset_password.password_mismatch');
    ...
    (0, debug_1.debug)('auth.reset_password.updated');
});
const changePasswordToDB = (user, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isExistUser) {
        (0, debug_1.debug)('auth.change_password.user_missing');
        throw new ApiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, "User doesn't exist!");
    }
    //current password match
    if (currentPassword &&
        !(yield user_model_1.User.isMatchPassword(currentPassword, isExistUser.password))) {
        (0, debug_1.debug)('auth.change_password.password_incorrect');
        throw new ApiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'Password is incorrect');
    }
    //newPassword and current password
    if (currentPassword === newPassword) {
        (0, debug_1.debug)('auth.change_password.same_password');
    ...
    if (newPassword !== confirmPassword) {
        (0, debug_1.debug)('auth.change_password.mismatch');
    ...
    (0, debug_1.debug)('auth.change_password.updated');
});
exports.AuthService = {
    verifyEmailToDB,
    loginUserFromDB,
    ...
    resendVerifyEmailToDB: (email, role) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (isExistUser.verified) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'User already verified');
        }
        const otp = (0, generateOTP_1.default)();
        const values = {
        ...
        (0, debug_1.debug)('auth.resend_verify.sent', { email });
        const authentication = {
            oneTimeCode: otp,
            expireAt: new Date(Date.now() + 3 * 60000),
        };
    ...
    refreshTokenToDB: (token) => __awaiter(void 0, void 0, void 0, function* () {
        if (!token) {
            (0, debug_1.debug)('auth.refresh_token.missing');
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.UNAUTHORIZED, 'You are not authorized');
        }
        const decoded = jwtHelper_1.jwtHelper.verifyToken(token, config_1.default.jwt.jwt_refresh_secret);
        const accessToken = jwtHelper_1.jwtHelper.createToken({ id: decoded.id, role: decoded.role, email: decoded.email }, config_1.default.jwt.jwt_secret, config_1.default.jwt.jwt_expire_in);
        (0, debug_1.debug)('auth.refresh_token.created');
        return accessToken;
    }),
};
