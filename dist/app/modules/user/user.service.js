...
const createUserToDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, debug_1.debug)('user.register.otp_created', { email: createUser.email, otp });
    const values = {
    ...
    (0, debug_1.debug)('user.register.email_send_attempt', { email: createUser.email });
    //save to DB
    ...
    (0, debug_1.debug)('user.register.otp_saved', { email: createUser.email });
    return createUser;
});
