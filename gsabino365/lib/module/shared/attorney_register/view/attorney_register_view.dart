...
class AttorneyRegisterView extends GetView<AttorneyRegisterController> {
  const AttorneyRegisterView({super.key});
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // Licensed States to Practice
                CustomTextField(
                  label: 'Licensed States to Practice',
                  hintText: 'e.g. Nationwide or NY, CA, TX',
                  controller: controller.licensedStatesController,
                  validator: (value) {
                    if (value == null || value.trim().isEmpty) {
                      return 'Please enter licensed states';
                    }
                    return null;
                  },
                ),
                ...
                Obx(
                  () => DropdownButtonFormField<String>(
                    // initialValue is supported by newer Flutter/DropdownButtonFormField,
                    // but for compatibility we use value property but properly handle nulls.
                ...
                CustomTextField(
                  ...
                  validator: (value) {
                    if (value == null || value.trim().isEmpty) {
                      return 'Please enter Bar Association Number';
                    }
                    return null;
                  },
                ),
                ...
                CustomTextField(
                  label: 'Law Firm Name',
                  hintText: 'Enter Law Firm Name',
                  controller: controller.lawFirmController,
                  validator: (value) {
                    if (value == null || value.trim().isEmpty) {
                ...
                // Date Passed The Bar
                CustomTextField(
                  label: 'Date Passed The Bar',
                  hintText: 'Enter Date', // Exact match from mockup typo but corrected text input description
                  controller: controller.datePassedBarController,
                  validator: (value) {
                    if (value == null || value.trim().isEmpty) {
